"""
Potencial de Morse optimizado con Numba para máximo rendimiento en 3D.

Este módulo implementa el potencial de Morse para estructuras cristalinas 3D
usando compilación JIT con Numba, logrando speedups de 100-1000× en funciones críticas.
